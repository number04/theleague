...
class RosterController extends Controller
{
    ...
    public function roster(Request $request)
    {
        ...
        return view('roster', [
            ...
            'center_user' => $this->roster->skater($user_id, 'C'),
            'left_user' => $this->roster->skater($user_id, 'L'),
            'right_user' => $this->roster->skater($user_id, 'R'),
            'defence_user' => $this->roster->skater($user_id, 'D'),
            'goalie_user' => $this->roster->goalie($user_id),
            'team_user' => $this->roster->team($user_id),
