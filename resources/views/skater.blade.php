...
<div class="container-player">
    ...
    <div class="table">
       <div class="th">
           <ul>
               ...
               <li class="stats"><a href="?order=goals&sort={{ $sort }}">g</a></li>
               <li class="stats"><a href="?order=assists&sort={{ $sort }}">a</a></li>
               <li class="stats"><a href="?order=points&sort={{ $sort }}">pts</a></li>
               <li class="stats"><a href="?order=hits&sort={{ $sort }}">ht</a></li>
               <li class="stats"><a href="?order=shots&sort={{ $sort }}">s</a></li>
               <li class="stats"><a href="?order=faceoff_wins&sort={{ $sort }}">fow</a></li>
           </ul>
       </div>
   ...
   {{ $skaters->appends(request()->input())->links() }}
</div>
@endsection
