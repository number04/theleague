...
class CreateGoaliesLineupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('goalies_lineups', function (Blueprint $table) {
            ...
            $table->foreign('player_id')->references('id')->on('goalies');
        });
    }
    ...
    {
        Schema::dropIfExists('goalies_lineups');
    }
}
